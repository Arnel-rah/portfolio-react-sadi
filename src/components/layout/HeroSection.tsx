      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto">
        ...
        >
          ...
          <span className="text-indigo-400 font-mono text-[10px] md:text-xs uppercase tracking-[0.3em] font-bold">
            Based in 2026 · Available for projects
          </span>
        </motion.div>
        <motion.div
        ...
        >
          <h1 className="text-[13vw] sm:text-[10vw] md:text-[8vw] font-medium leading-[0.85] tracking-[-0.04em] text-white mb-10">
            ...
            <span className="text-white/40 italic font-light">Software Engineer</span>
          </h1>
        </motion.div>
        <motion.div 
          initial={{ opacity: 0 }}
        ...
        >
          <p className="text-slate-400 text-lg sm:text-2xl leading-relaxed font-light">
            I build <span className="text-white font-normal">distributed systems</span> and 
            high-performance backends using <span className="text-indigo-400 font-mono italic">Go</span>. 
            Focused on scalability and elegant architecture.
          </p>
        </motion.div>
        <div className="flex flex-col md:flex-row md:items-center gap-12 pt-12 border-t border-white/10">
          ...
          >
            ...
            <div className="flex flex-col">
                ...
                <span className="text-sm uppercase tracking-widest font-black">Initialize Connection</span>
            </div>
